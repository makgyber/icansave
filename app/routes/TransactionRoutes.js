...
module.exports = function(app) {
    ...
    app.get('/api/trans/getRecentTransactions', controller.getRecentTransactions);
    app.post('/api/trans/approveOrRevokeTransaction', controller.approveOrRevokeTransaction);
